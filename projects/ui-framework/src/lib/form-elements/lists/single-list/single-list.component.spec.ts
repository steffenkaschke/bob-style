...
fdescribe('SingleListComponent', () => {
  ...
  let domStub: jasmine.SpyObj<DOMhelpers>;
  let zoneStub: jasmine.SpyObj<NgZone>;
  ...
  beforeEach(async(() => {
    ...
    // domStub = createSpyObj('DOMhelpers', ['isEmpty']);
    // domStub.isEmpty.and.returnValue(true);
    //
    // zoneStub = createSpyObj('NgZone', ['runOutsideAngular']);
    // zoneStub.runOutsideAngular.and.callFake((f) => f());
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        ListKeyboardService,
        // DOMhelpers,
        // { provide: DOMhelpers, useValue: domStub },
        // { provide: NgZone, useValue: zoneStub },
      ],
      imports: [
