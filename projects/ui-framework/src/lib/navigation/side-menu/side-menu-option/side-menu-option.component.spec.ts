...
describe('SideMenuOptionComponent', () => {
  ...
  describe('template', () => {
    ...
    it('should add selected-option class to side-menu-option-container', () => {
      expect(sideMenuOptionContainer.nativeElement.classList).toContain('selected-option');
    });
    ...
    it('should display prefix component', () => {
      expect(prefixComponent.nativeElement).toBeTruthy();
    });
