      ...
      .subscribe((e: KeyboardEvent) => {
        switch (e.code) {
          case(NavigationKeys.down):
            this.focusIndex = this.listKeyboardService.getNextFocusIndex(NavigationKeys.down, this.focusIndex, this.options.length);
          ...
          case(NavigationKeys.up):
            this.focusIndex = this.listKeyboardService.getNextFocusIndex(NavigationKeys.up, this.focusIndex, this.options.length);
            this.focusOption = this.options[this.focusIndex];
            this.vScroll.scrollToIndex(this.listKeyboardService.getScrollToIndex(this.focusIndex, this.maxHeight));
            break;
