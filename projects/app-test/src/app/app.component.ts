...
import { DateInputDirective } from '../../../ui-framework/src/lib/form-elements/date-picker/dateinput.directive';
import { DateParseService } from '../../../ui-framework/src/lib/form-elements/date-picker/date-parse.service';
...
export class AppComponent {
  ...
  test = {
    'dd/MM/yyyy': {
      '02 03 2010': { result: '02/03/2010', resultStrict: '02/03/2010' },
      '2010 feb 10': { result: '10/02/2010', resultStrict: '10/02/2010' },
      'feb.10.2010': { result: '10/02/2010', resultStrict: '10/02/2010' },
      '10 feb 2010': { result: '10/02/2010', resultStrict: '10/02/2010' },
      ...
      '2 2010 20 5': { result: '20/02/2010', resultStrict: '20/02/2010' },
    },
    'dd/MMM/yyyy': {
      '02 03 2010': { result: '02/Mar/2010', resultStrict: '02/Mar/2010' },
      '2010 feb 10': { result: '10/Feb/2010', resultStrict: '10/Feb/2010' },
      'feb.10.2010': { result: '10/Feb/2010', resultStrict: '10/Feb/2010' },
      '10 feb 2010': { result: '10/Feb/2010', resultStrict: '10/Feb/2010' },
      ...
      '2 2010 20 5': { result: '20/Feb/2010', resultStrict: '20/Feb/2010' },
    },
    'MMM/dd/yyyy': {
      '02 03 2010': { result: 'Feb/03/2010', resultStrict: 'Feb/03/2010' },
      '2010 feb 10': { result: 'Feb/10/2010', resultStrict: 'Feb/10/2010' },
      'feb.10.2010': { result: 'Feb/10/2010', resultStrict: 'Feb/10/2010' },
      '10 feb 2010': { result: 'Feb/10/2010', resultStrict: 'Feb/10/2010' },
    ...
    'MMM/dd/yy': {
      'feb.10.2010': { result: 'Feb/10/10', resultStrict: 'Feb/10/10' },
    ...
    'yyyy/MM/dd': {
      '02 03 2010': { result: '2010/02/03', resultStrict: '2010/02/03' },
      '2010 feb 10': { result: '2010/02/10', resultStrict: '2010/02/10' },
      'feb.10.2010': { result: '2010/02/10', resultStrict: '2010/02/10' },
      '10 feb 2010': { result: '2010/02/10', resultStrict: '2010/02/10' },
      ...
      '2 2010 20 5': { result: '2010/02/20', resultStrict: '2010/02/20' },
    },
    'yy/MM/dd': {
      '2010 feb 10': { result: '10/02/10', resultStrict: '10/02/10' },
      'feb.10.2010': { result: '10/02/10', resultStrict: '10/02/10' },
      '20 02': {
      ...
      '2 2010 20 5': { result: '10/02/20', resultStrict: '10/02/20' },
    },
    'yy/dd/MM': {
      '02 03 2010': { result: '10/02/03', resultStrict: '10/02/03' },
      '2010 feb 10': { result: '10/10/02', resultStrict: '10/10/02' },
      'feb.10.2010': { result: '10/10/02', resultStrict: '10/10/02' },
      '10 feb 2010': { result: '10/10/02', resultStrict: '10/10/02' },
      ...
      '2 2010 20 5': { result: '10/20/02', resultStrict: '10/20/02' },
    },
    'MMM-dd-yyyy': {
      'feb.10.2010': { result: 'Feb-10-2010', resultStrict: 'Feb-10-2010' },
      '2010 5 20': { result: 'May-20-2010', resultStrict: 'May-20-2010' },
    ...
    'MM-dd-yyyy': {
      '02 03 2010': { result: '02-03-2010', resultStrict: '02-03-2010' },
      '2010 feb 10': { result: '02-10-2010', resultStrict: '02-10-2010' },
      'feb.10.2010': { result: '02-10-2010', resultStrict: '02-10-2010' },
      '10 feb 2010': { result: '02-10-2010', resultStrict: '02-10-2010' },
      ...
      '2 2010 20 5': { result: '02-20-2010', resultStrict: '02-20-2010' },
    },
    'dd-MMM-yyyy': {
      '5-20-2010': { result: '20-May-2010', resultStrict: '20-May-2010' },
      '2010 05': { result: '01-May-2010', resultStrict: null },
    ...
    yyyy: {
      '02 03 2010': { result: '2010', resultStrict: thisYear() + '' },
      '10 feb 2010': { result: '2010', resultStrict: thisYear() + '' },
      '20 5 2010': { result: '2010', resultStrict: thisYear() + '' },
      '5-20-2010': { result: '2010', resultStrict: thisYear() + '' },
      '20 02': {
        result: thisYear() + '',
      ...
      '5 2010 3': { result: '2010', resultStrict: thisYear() + '' },
      '2010 05': { result: '2010', resultStrict: '2010' },
      '2 2010 20 5': { result: '2010', resultStrict: thisYear() + '' },
      'feb.10.2010': { result: '2010', resultStrict: thisYear() + '' },
      'mar 2010 2 20': { result: '2010', resultStrict: thisYear() + '' },
      'may 2010': { result: '2010', resultStrict: thisYear() + '' },
    },
    'mm/yyyy': {
      '02 03 2010': { result: '02/2010', resultStrict: '02/' + thisYear() },
      'feb.10.2010': { result: '02/2010', resultStrict: '02/' + thisYear() },
      '10 feb 2010': { result: '02/2010', resultStrict: '02/' + thisYear() },
      '20 5 2010': { result: '05/2010', resultStrict: '05/' + thisYear() },
      '5-20-2010': { result: '05/2010', resultStrict: '05/' + thisYear() },
      '20 02': {
        result: '02/' + thisYear(),
      ...
      'mar 2010 2 20': { result: '03/2010', resultStrict: '03/2010' },
      '04': {
        result: '04/' + thisYear(),
        resultStrict: null,
      },
      ...
      '2010 feb 10': { result: '02/2010', resultStrict: '02/2010' },
      '2010 5 20': { result: '05/2010', resultStrict: '05/2010' },
      '2010/5/3': { result: '05/2010', resultStrict: '05/2010' },
      '5 2010 3': { result: '05/2010', resultStrict: '05/2010' },
      '2010 05': { result: '05/2010', resultStrict: '05/2010' },
      'may 2010': { result: '05/2010', resultStrict: '05/2010' },
      '03 2010 20 5': { result: '03/2010', resultStrict: '03/2010' },
    },
    mm: {
      ...
      '2010': { result: '01', resultStrict: thisMonth() },
      '2010 feb 10': { result: '02', resultStrict: thisMonth() },
